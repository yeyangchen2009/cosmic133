...
//    }
     ...
     * @since JDK 1.8
     */
    public static String sendPostByUrlEncoder(String url,Map<String, String> headMap,Map<String, String> map){
        List<NameValuePair> params=new ArrayList<NameValuePair>();
...
//        httppost.setHeader("Authorization","Basic NWU2YWUwNTAtMjljYy0yMDE1LThhMjktMDE0ODA5MGFhMjk2OmE0NGQxNDkwLWNjZGMtNzA2OC1iOWJiLWQ4YzAyODllZDgzYQ==");
